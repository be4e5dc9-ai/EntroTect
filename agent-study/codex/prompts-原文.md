...
> 提取自 `D:\my agent\codex\codex-rs\` @ commit `
> 结构说明：基础指令按模型版本分文件放在 core/ 下；其余提示词集中在 prompts crate（codex-rs/prompts/templates/），经 include_str!/codex_prompts 引用（如 SUMMARIZATION_PROMPT = templates/compact/prompt.md）。

## 1. 基础指令 · gpt_5_codex_prompt.md

> 来源：`codex-rs/core/gpt_5_codex_prompt.md`（全文 68 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 2. 基础指令 · gpt-5.1-codex-max_prompt.md

> 来源：`codex-rs/core/gpt-5.1-codex-max_prompt.md`（全文 80 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 3. 基础指令 · gpt-5.2-codex_prompt.md

> 来源：`codex-rs/core/gpt-5.2-codex_prompt.md`（全文 80 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 4. 基础指令 · gpt_5_1_prompt.md

> 来源：`codex-rs/core/gpt_5_1_prompt.md`（全文 331 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 5. 基础指令 · gpt_5_2_prompt.md

> 来源：`codex-rs/core/gpt_5_2_prompt.md`（全文 298 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 6. 基础指令 · prompt_with_apply_patch_instructions.md

> 来源：`codex-rs/core/prompt_with_apply_patch_instructions.md`（全文 351 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 7. prompts 模板 · compact/prompt.md

> 来源：`codex-rs/prompts/templates/compact/prompt.md`（全文 9 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 8. prompts 模板 · compact/summary_prefix.md

> 来源：`codex-rs/prompts/templates/compact/summary_prefix.md`（全文 1 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写

``````
A
``````

## 9. prompts 模板 · review/rubric.md

> 来源：`codex-rs/prompts/templates/review/rubric.md`（全文 95 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 10. prompts 模板 · goals/continuation.md

> 来源：`codex-rs/prompts/templates/goals/continuation.md`（全文 51 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 11. prompts 模板 · permissions/approval_policy/on_request.md

> 来源：`codex-rs/prompts/templates/permissions/approval_policy/on_request.md`（全文 57 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
...
## 12. prompts 模板 · permissions/approval_policy/unless_trusted.md

> 来源：`codex-rs/prompts/templates/permissions/approval_policy/unless_trusted.md`（全文 1 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写

``````
 
``````

## 13. prompts 模板 · permissions/approval_policy/never.md

> 来源：`codex-rs/prompts/templates/permissions/approval_policy/never.md`（全文 1 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写

``````
A
``````

## 14. prompts 模板 · realtime/backend_prompt.md

> 来源：`codex-rs/prompts/templates/realtime/backend_prompt.md`（全文 65 行）@ commit `343074d4207d572809bd8cea15f4be1d09d98e0b` —— 逐字原文，未改写
